...
def create_splats_with_optimizers(
    ...
    device: str = "cuda",
) -> tuple[ParameterDict, list[SparseAdam | Adam]]:
    N = points.shape[0]
...
class Runner(Config):
    ...
    def __init__(self) -> None:
        ...
        # nerf viewer
        self.init_view(self._viewer_render_fn)
            ...
            for step in pbar:
                ...
                if step < self.refine_stop_iter:
                    ...
                    if step > self.refine_start_iter and step % self.refine_every == 0:
                        ...
                        # prune GSs
                        is_prune = (
                            torch.sigmoid(self.splats["opacities"]) < self.prune_opa
                        )
                    ...
                    if step % self.reset_every == 0:
                        self.reset_opa(self.prune_opa * 2.0)
    ...
    def eval(self, step: int):
        ...
        for i, data in enumerate(self.trainset):
            ...
            # Ks = data["K"].to(device)
            pixels = data.color.unsqueeze(0) / 255.0
        ...
        ellipse_time /= len(self.trainset)
